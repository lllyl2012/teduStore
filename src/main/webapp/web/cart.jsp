...
<div class="big">
    <form  name="" action="${base}/order/toAdd.do" method="post">
    <section id="section" >
        <div id="title">
            <b>购物车</b>
            <p>
            ...
            <div id="content_box">
                ...
                <c:forEach var="i" items="${cartList}">
	                <div class="imfor">
	                    <div class="check">
	                        <div class="Each">
	                            <span class="normal" title="${i.id},${i.goodsTitle},${i.goodsImage},${i.goodsPrice}">
	                                <img src="../images/cart/product_normal.png" alt=""/>
	                            </span>
	                    ...
	                    <div class="pudc">
	                        <div class="pudc_information" id="${i.id}">
	                            <img class="cartImage" src="${base}${i.goodsImage}" class="lf"/>
	                            <input type="hidden" name="" value="">
	                        <span class="des lf">
	                           		${i.goodsTitle}
	                              <input type="hidden" name="goodsTitle" value="${i.goodsTitle}">
	                        </span>
	                    ...
	                    <div class="pices">
	                        ...
	                        <p class="pices_information"><b>￥</b><span>${i.goodsPrice}.00  <input type="hidden" name="goodsPrice" value="${i.goodsPrice}"></span></p>
	                    </div>
	                    <div class="num"><span class="reduc">&nbsp;-&nbsp;</span><input type="text" name="num" value="${i.num}" ><span class="add">&nbsp;+&nbsp;</span></div>
	                    <div class="totle">
	                        <span>￥</span>
	                        <span class="totle_information">${i.goodsPrice * i.num}.00</span>
	                    </div>
	                    <div class="del">
	                        <!-- <div>
  ...
  $("#go-buy").click(function(){
	  ...
	  var json = "[";
    	for(var i=0;i<goods.length;i++){
    		var array= $(".true")[0].title.split(",");
    			if(i==(goods.length-1)){
    				console.log(1);
    				json = json+"{'goodsId':"+array[0]+",'goodsTitle':"+array[1]+",'goodsImage':"+array[2]+",'goodsPrice':"+array[3]+"}";
    				break;
    				}
    			json = json+"{'goodsId':"+array[0]+",'goodsTitle':"+array[1]+",'goodsImage':"+array[2]+",'goodsPrice':"+array[3]+"},";
    		}
