...
<body>
	<div id="goods_list_section_wrapper">
		...
		<ul id="goods_list">
			...
			<li class="item">
				<div class="image">
					<a href="${base}/goods/detail.do?id=${goods.id}"><img src="${pageContext.request.contextPath }${goods.image }"
						alt="${goods.title }" 
						title="${goods.title }" /></a>
				</div>
				<div class="title">
				...
				<div class="buy">
					...
					<span class="add_cart" title="${goods.id}">
						<img id="collect" 
		...
		<div class="pages">
			<c:forEach var="i" begin="1" end="${pageNum}">
				...
				<c:if test="${i !=page }">
					<a href="${pageContext.request.contextPath }/goods/list.do?id=${categoryId }&page=${i}">
						${i}</a>
				</c:if>
			</c:forEach>
		</div>
