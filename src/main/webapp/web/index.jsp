...
<div class="lf1">
    <div class="lf1_top">
        ...
        <div class="right lf">
            ...
            <span><img src="../images/itemCat/study_computer_img2.png" alt="" title=""/></span>
        </div>
    </div>
    <div class="lf1_bottom">
        <div class="item_cat lf">
            ...
            <div class="item_cat_all">
                <c:forEach var="i" items="${categoryList}" varStatus="stat">
                	<p>${i.name}</p>
                	<ul>
                	<c:forEach var="a" items="${subCategory[stat.index]}">
										<li><a href="${base}/goods/list.do?id=${a.id}">${a.name}</a></li>
                	</c:forEach>
                </ul>
                </c:forEach>
            </div>
        </div>
        <c:forEach var="i" items="${computerList}">
	        	<div class="item_msg lf">
	            <img src="${base}${i.image}" title="${i.title}" alt="${i.title}"/>
	
	            <p class="bottom_ys2">${i.title}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
	
	            <p class="bottom_ys3">￥${i.price}</p>
	
	            <p class="bottom_ys4 color_2"><a href="${base}/goods/details.do?id=${i.id}">查看详情</a></p>
	        </div>
        </c:forEach>
