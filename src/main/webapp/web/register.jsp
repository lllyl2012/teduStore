    ...
    <div class="panel rt">
      <form id="form-register" method="post" action="">
        <div class="txt">
          <p>新用户注册
            <span>
              <a href="${base}/user/login.do">直接登录</a>
            </span>
          </p>
        </div>
...
<script>
  ...
  uname.onblur = function(){
   ...
   $.ajax({
    	"url":projectName+"/user/checkUsername.do",
    	"data":"username="+data,
    	"datatype":"json",
    	"type":"get",
    	"success":function(json){
    		var css = json.state==1?"msg-success":"msg-error";
    		$("#uname").next().attr("class",css);
    	  $("#uname").next().text(json.message);
    	    }
      });
