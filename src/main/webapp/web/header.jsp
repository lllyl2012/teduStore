    ...
    <div class="rt">
        <ul class="lf">
        		<c:if test="${sessionScope.uid != null}">
        			<li><a href="${base}/user/user_center.do">${username}</a><b>|</b></li>
        		</c:if>
            ...
            <li><a href="${base}/cart/list.do" title="我的购物车"><img class="shopcar" src="../images/header/shop_car.png" alt=""/></a><b>|</b></li>
            <li><a href="help.html">帮助</a><b>|</b></li>
            <c:if test="${sessionScope.uid == null}">
            	<li><a href="${base}/user/login.do">登录</a><b>|</b></li>
            </c:if>
            <c:if test="${sessionScope.uid != null}">
            	<li><a href="${base}/user/logout.do">退出</a><b>|</b></li>
            </c:if>
        </ul>
    </div>
</header>