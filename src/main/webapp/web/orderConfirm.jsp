...
<div id="container" class="clear">
    ...
    <div class="adress_choice">
        <p>收货人信息<a href="${base}/user/address.do"><span class="rt" id="choose">更改默认收货地址</span></p></a>
        <div id="addresId1" class="base_select">
            <i class="address_name">
                ${address.recvPerson}
            </i>
            <i class="user_address">
             	${address.recvDistrict} ${address.recvAddr}
            </i>
            <a href="${base}/user/address.do"><i class="user_site rt">
                更改默认地址
            </i></a>
        </div>
